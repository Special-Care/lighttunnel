...
const protocolTypeStr = 'dmxlc3M=';
function configInfo(UUID, domainAddress) {
	const 协议类型 = atob(protocolTypeStr);
	
	const 别名 = domainAddress;
	let 地址 = domainAddress;
	let 端口 = 443;
...
Base64订阅地址:
https://${hostName}/${uuid}?sub
https://${hostName}/${uuid}?b64
https://${hostName}/${uuid}?base64

clash订阅地址:
https://${hostName}/${uuid}?clash

singbox订阅地址:
https://${hostName}/${uuid}?sb
https://${hostName}/${uuid}?singbox
---------------------------------------------------------------
################################################################
v2ray
---------------------------------------------------------------
